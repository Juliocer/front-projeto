...
export default function Layout({children}: Props){
    return (
        <main className="min-h-screen flex justify-center mx-auto max-w-7xl">
            <section className="hidden lg:flex flex-col sticky top-0 h-screen w-60 px-3">
            ...
            <aside className="hidden lg:flex flex-col gap-6 sticky top-0 h-fit w-85 px-8 py-6">
